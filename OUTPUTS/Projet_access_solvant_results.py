...
#Main program
file_PDB = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/Project-final/PDB/7kh5.pdb"
...
reponse = input("Entrez un nombre de points (entier positif): ")
...
output_filename = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/Project-final/RESULTS/results_area_1000.txt"
...
with open(output_filename, "w") as output_file:
    ...
    for residue, somme in sum_by_AA.items():
        ...
        result_line = f"Residue {residue:3} {nom_AA:<4}: Area(Å²) = {somme:>6.2f}"

        # Écrire la ligne de résultat dans le fichier de sortie
        output_file.write(result_line + "\n")


# Le fichier "resultats_area.txt" contiendra maintenant les résultats d'aire en Å²
print("Les résultats d'aire en Å² ont été enregistrés dans", output_filename)

# Displays the result of the Relative Solvent Accessibility (RSA)

# Définir le nom du fichier de sortie
output_filename = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/Project-final/RESULTS/results_rsa_1000.txt"
...
with open(output_filename, "w") as output_file:
    ...
    for residue, somme in sum_by_AA.items():
        ...
        result_line = f"Residue {residue:3} {num_to_nom_AA[residue]:<4}: RSA = {RSA:>4.2f}"

        # Écrire la ligne de résultat dans le fichier de sortie
        output_file.write(result_line + "\n")

# Le fichier "resultats_rsa.txt" contiendra maintenant les résultats RSA
print("Les résultats RSA ont été enregistrés dans", output_filename)

# Displays Solvent Accessible Surface Area (SASA) results for each residue

# Définir le nom du fichier de sortie
output_filename = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/Project-final/RESULTS/results_sasa_1000.txt"
...
with open(output_filename, "w") as output_file:
    ...
    for val in range(len(surf_T)):
        ...
        result_line = f"Residue {val+1:3} {nom_AA:<4}: SASA(%) = {SASA:>5.2f}"

        # Écrire la ligne de résultat dans le fichier de sortie
        output_file.write(result_line + "\n")

# Le fichier "resultats_sasa.txt" contiendra maintenant les résultats
print("Les résultats ont été enregistrés dans", output_filename)