...
# Set output filename
output_filename = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/GIT_PRJCT/Project_M2BI/OUTPUTS/results_area.txt"
...
with open(output_filename, "w") as output_file:
    ...
    for residue, somme in sum_by_AA.items():
        ...
        result_line = f"Residue {residue:3} {nom_AA:<4}: Area(A2) = {somme:>6.2f}"

        # Write the result line to the output file
        output_file.write(result_line + "\n")

print("The area results in Å² have been saved in", output_filename)

# Displays the result of the Relative Solvent Accessibility (RSA)

# Set output filename
output_filename = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/GIT_PRJCT/Project_M2BI/OUTPUTS/results_rsa.txt"
...
print("The RSA results have been saved in", output_filename)

# Displays Solvent Accessible Surface Area (SASA) results for each residue

# Set output filename
output_filename = "//wsl.localhost/Ubuntu/home/qcapdet/M2BI/GIT_PRJCT/Project_M2BI/OUTPUTS/results_sasa.txt"
...
print("The SASA results have been saved in", output_filename)